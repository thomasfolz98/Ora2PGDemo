...
SELECT ora2pg_upd_autoincrement_seq('kunden','id');
SELECT ora2pg_upd_autoincrement_seq('rechnungen','id');
SELECT ora2pg_upd_autoincrement_seq('rechnungspositionen','id');
