...
# Stoppt die API, loescht die Schemata 'app_demo' und 'pkg_faktura' in Postgres.
...
msg "1/4  API stoppen"
$COMPOSE stop api-advanced

msg "2/4  Pruefe Postgres-Container"
...
msg "3/4  Drop Schemata 'app_demo' + 'pkg_faktura'"
